...
procedure TForm14.Button2Click(Sender: TObject);   // Расчет скидки
var
discount: Double;
summa: double;
count: integer;
...
begin
  ...
  WordApp.visible := True;
    ...
    NewDoc.bookmarks.item('z2').range.insertafter(ADOQueryBin.FieldByName('дата').Value);
    ...
    NewDoc.bookmarks.item('z5').range.insertafter(ADOQueryBin.FieldByName('количество').Value);
